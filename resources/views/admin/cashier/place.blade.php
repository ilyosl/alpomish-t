    ...
    <div class="box box-warning">
        ...
        <div class="box-body" style="display: block;">
            ...
            <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                 width="700.000000pt" height="531.000000pt" viewBox="0 0 1500.000000 1031.000000"
                ...
                <g transform="translate(0.000000,1031.000000) scale(0.100000,-0.100000)"
                   fill="#000" stroke="none">
                    @foreach($path as $p)
                        <a class="alp-path"
                           href="{{ url('/admin/cashier/place?eventId='.$event->id.'&blockName='.$p->name_block.'&eventTime='.$event->eventTimes[0]->eventTime).'&eventDate='. $event->eventTimes[0]->eventDate }}"
                           rel="tooltip"
                           data-trigger="hover"
